            ...
            return (
                <div className="flex">
                    <div className="text-center mr-0 pl-0 mt-64 w-48 text-gray-200 bg-gray-700" style={{marginLeft: "32.5%"}}>
                        ...
                        <button className="btn btn-primary mt-8 rounded-sm font-normal">Ausloggen</button>
                    </div>
                    <div className="container mt-64 max-w-md text-gray-200">
                        <div className="card">
                            <ul className="flex border-b-2 border-gray-300 bg-white">
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-blue-500 py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white" data-arg="home" onClick={this.changePage.bind(this)}>Home</a>
                            </li>
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-white hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-2 px-4" data-arg="cashout" onClick={this.changePage.bind(this)}>Auszahlen</a>
                            </li>
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-white hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-2 px-4" data-arg="cashin" onClick={this.changePage.bind(this)}>Einzahlen</a>
                            </li>
                ...
                <div className="flex">
                    ...
                    <div className="container mt-64 max-w-md text-gray-200">
                        <div className="card">
                            <ul className="flex border-b-2 border-gray-300 bg-white">
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-white hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-2 px-4" data-arg="home" onClick={this.changePage.bind(this)}>Home</a>
                            </li>
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-blue-500 py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white" data-arg="cashout" onClick={this.changePage.bind(this)}>Auszahlen</a>
                            </li>
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-white hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-2 px-4" data-arg="cashin" onClick={this.changePage.bind(this)}>Einzahlen</a>
                            </li>
                ...
                <div className="flex">
                    ...
                    <div className="container mt-64 max-w-md text-gray-200">
                        <div className="card">
                            ...
                            <li className="flex-1 mr-2">
                                <a className="text-center block border border-white py-2 px-4 bg-blue-500 hover:bg-blue-700 text-white" data-arg="cashin" onClick={this.changePage.bind(this)}>Einzahlen</a>
                            </li>
                            <li className="text-center flex-1">
                                <a className="block py-2 px-4 text-gray-400 cursor-not-allowed" data-arg="transferlog">Kontoauszug</a>
                            </li>
