  ...
  render() {
    return (
      <div class="container flex flex-wrap pt-4 pb-10 m-auto mt-48 md:mt-15 lg:px-12 transform scale-75">
        <div class="card-header container text-3xl">Autovermietung</div>
          <div class="card-body container">
            <div class="w-full px-0 lg:px-4">
              <h2 class="px-12 text-center md:text-2xl text-white">Willkommen bei der Autovermietung Rent-A-Car!</h2>
              <hr className="mx-auto mt-4" style={{width: "40rem"}}></hr>
              <div class="flex flex-wrap items-center justify-center py-4 pt-0 mt-4">
