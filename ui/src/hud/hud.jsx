    ...
    if (!this.state.hidden) {
      return (
        <div className="select-none">
          <div className="absolute top-0 right-0 mx-3 my-3"><img src="https://static.exo.cool/exov-static/images/hud/HUD.png"></img></div>
          ...
          <div id="microphone" className="absolute right-0 top-0 mx-8 my-12 w-10 h-10 mt-20 bg-gray-900 rounded-full opacity-75 shadow-xl">
            <img className="absolute mx-auto w-6 h-6 mt-2 shadow-img" src="https://static.exo.cool/exov-static/images/hud/icons/microphone.png" style={{marginLeft: "0.5rem"}}></img>
          ...
          <div id="hungerBg" className="absolute right-0 top-0 mx-20 my-12 w-10 h-10 mt-20 bg-gray-900 rounded-full opacity-75 shadow-xl">
            <img className="absolute mx-auto w-6 h-6 mt-2 shadow-img" src="https://static.exo.cool/exov-static/images/hud/icons/hunger.png" style={{marginLeft: "0.5rem"}}></img>
          ...
          <div id="healthBg" className="absolute right-0 top-0 mx-32 my-12 w-10 h-10 mt-20 bg-gray-900 rounded-full opacity-75 shadow-xl">
            <img className="absolute mx-auto w-6 h-6 mt-2 shadow-img" src="https://static.exo.cool/exov-static/images/hud/icons/health.png" style={{marginLeft: "0.5rem"}}></img>
          ...
          <div id="kevlarBg" className="absolute right-0 top-0 my-12 w-10 h-10 mt-20 bg-gray-900 rounded-full opacity-75 shadow-xl" style={{marginRight: "11rem"}}>
            <img className="absolute mx-auto w-6 h-6 mt-2 shadow-img" src="https://static.exo.cool/exov-static/images/hud/icons/kevlar.png" style={{marginLeft: "0.5rem"}}></img>
